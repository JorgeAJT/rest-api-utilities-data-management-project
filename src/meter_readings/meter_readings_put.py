...
@meter_readings_put_router.put('/meter_readings/{meter_readings_id}', response_model=Response)
async def put_meter_readings(meter_readings_id: int, meter_readings_request: MeterReadingsRequest):
    try:
